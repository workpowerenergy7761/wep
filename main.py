...
async def upload(bot: Client, m: Message):
    ...
    credit = "️[𝗗𝗢𝗖𝗧𝗢𝗥_𝗝𝗕](https://t.me/DOCTOR_JB)"
    if raw_text3 == '1':
        CR = '[𝗗𝗢𝗖𝗧𝗢𝗥_𝗝𝗕](https://t.me/DOCTOR_JB)'
    elif raw_text3:
        try:
    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            if "visionias" in url:
             ...
             url = f"https://anonymouspwplayer-b99f57957198.herokuapp.com/pw?url={video_url}?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..61VjZvxJ41fn0lTcw8Bwgi6dTn5sGmRm8bDTNai4ECE"
            #elif '/master.mpd' in url:
             #id =  url.split("/")[-2]
